...
namespace Reviews
{
    ...
    public sealed partial class SearchPage : BasePage
    {
        ...
        private async void TxtSuggestion_OnTextChanged(AutoSuggestBox sender, AutoSuggestBoxTextChangedEventArgs args)
        {
        ...
        private async void TxtSuggestion_OnSuggestionChosen(AutoSuggestBox sender, AutoSuggestBoxSuggestionChosenEventArgs args)
        {
